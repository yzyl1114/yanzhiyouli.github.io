...
exports.Stream = exports.readableStreamAsyncIterable = exports._decodeChunks = exports.LineDecoder = exports.SSEDecoder = void 0;
...
class Stream {
            ...
            try {
                for await (const sse of iterMessages()) {
                    ...
                    if (sse.event === null) {
                        ...
                        if (data && data.error) {
                            throw new error_js_1.APIError(undefined, data.error, undefined, undefined);
                        }
                        yield data;
                    }
                    else {
                        ...
                        if (sse.event === 'error') {
                            throw new error_js_1.APIError(undefined, data.error, data.message, undefined);
                        }
     ...
     */
    static fromReadableStream(readableStream, controller, options) {
        let consumed = false;
